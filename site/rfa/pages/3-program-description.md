...
*A. Agentic AI-Driven Chemical Manufacturing (BES)* — **truncated** (not in scope; see [source PDF](../DE-FOA-0003612.pdf)).

*B. AI-Driven Materials Processing (BES)* — **truncated** (not in scope; see [source PDF](../DE-FOA-0003612.pdf)).

*C. AI-Enabled Manufacturing for Extreme Energy Systems (FES)* — **truncated** (not in scope; see [source PDF](../DE-FOA-0003612.pdf)).
...
*E. AI-Enabled Smart Manufacturing (AMMTO)* — **truncated** (not in scope; see [source PDF](../DE-FOA-0003612.pdf)).

*F. Energy Material Manufacturing (AFFO)* — **truncated** (not in scope; see [source PDF](../DE-FOA-0003612.pdf)).
...
*A. Biomolecular Science (BER)* — **truncated** (not in scope; see [source PDF](../DE-FOA-0003612.pdf)).

*B. Genotype to Phenotype (BER)* — **truncated** (not in scope; see [source PDF](../DE-FOA-0003612.pdf)).

*C. Predictive Engineering of Microbial Communities (BER)* — **truncated** (not in scope; see [source PDF](../DE-FOA-0003612.pdf)).

*D. Bio Design (BER)* — **truncated** (not in scope; see [source PDF](../DE-FOA-0003612.pdf)).
